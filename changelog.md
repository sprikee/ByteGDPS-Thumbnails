...
- Rebranded as ByteGDPS Thumbnails (`bytegdps.thumbnails`).
- Default API points at `https://bytegdps.ru/thumbs`, legacy PNG mode enabled by default.
- No other code changes: based on upstream v2.6.0.
